...
╰──────❍`
	...
	if (type == 1 || type == 'buttonMessage') {
		await naze.sendButtonMsg(m.chat, {
			text: `Halo @${m.sender.split('@')[0]}\n\nChannel WA: https://whatsapp.com/channel/0029Vb8EwT85PO0vP1iT4U3y\n\n` + text,
...
╰──────❍\n`
		await m.reply({
			...
			sourceUrl: 'https://whatsapp.com/channel/0029Vb8EwT85PO0vP1iT4U3y',
